...
public class DoWhileLoops01 {
    public static void main(String[] args) {
        ...
        */
        ...
        //Asagidaki kodu inceleyiniz. do-while loop’da loop’un en basta kirilmasi mumkun degildir. Once 1 kere
        // calistirilir (tabi sonsuz donguye sokulmazsa) Sonra kural kontrol edilir.
