...
public class DateTime01 {
    public static void main(String[] args) {
        ...
        // Örnek 1: now(): Geçerli tarihi alır. Tarih bilgisini yerel bilgisayarınızın saatinden alır,
        // yani sizin bilgisayarınızın saatinden gelir

        LocalDate myDate = LocalDate.now(); // now() methodu static bir methddur
        System.out.println(myDate); // 2024-06-03

        // Örnek 2 : getMonthValue(): Tarihin ayını (1-12 arasında) alır.
        ...
        System.out.println(myDate.getMonthValue()); // 6

        Month month = myDate.getMonth();
        System.out.println(month); // JUNE

        // Örnek 3: getYear() : Tarihin yılını alır

        System.out.println(myDate.getYear()); // 2024
        System.out.println(myDate.getDayOfYear()); // 155

        // Örnek 4: getDayOfMonth() : Ayın gününü alır

        int day1 = myDate.getDayOfMonth();
        System.out.println(day1); // 3

        DayOfWeek day2 = myDate.getDayOfWeek(); // DayOfWeek ENUM yapısıdır
        ...
        System.out.println(newDate); // 2025-08-07

        /* Örnek 6:Gecmis tarihe nasil gidilir?
        ...
        // Örnek 7: Specific bir tarih objesi nasil olusturulur?
        ...
        System.out.println("date 1 = " + date1 + ", date2 = " + date2); // date 1 = 1980-08-03, date2 = 2010-05-04
