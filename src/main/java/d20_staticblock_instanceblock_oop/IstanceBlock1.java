...
public class IstanceBlock1 {
    ...
    public static void main(String[] args) {
        ...
        IstanceBlock1 obj1 = new IstanceBlock1(); // merhaba Java kullanıcıları
        IstanceBlock1 obj2 = new IstanceBlock1(); // merhaba Java kullanıcıları
