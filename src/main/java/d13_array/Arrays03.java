...
public class Arrays03 {
    public static void main(String[] args) {
        ...
        int[] numbers = {12, 3, -3, 5, 23}; // Array i kısa yoldan oluşturduk
        ...
        */
        ...
        System.out.println(result); // 1 - Hangi indexte ise orayı söyler
        ...
        System.out.println(Arrays.binarySearch(arr, 3)); // -3 Olmadığından kaynaklı "-" olur verilen sayı ise
        // eğer olsaydı bu sayı nerde olurdu sorusunun cevabı
