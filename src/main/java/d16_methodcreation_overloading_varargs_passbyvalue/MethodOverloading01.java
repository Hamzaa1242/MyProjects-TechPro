...
public class MethodOverloading01 {
    public static void main(String[] args) {
        ...
        */
        ...
        // ----------------
        // String s = "Java";
        // s.substring() ==> Oluşturduğumuz object üzerinden bir methodu çağırırsak, o method non-statictir

        // Math.min() ==> min() methodunu class ismi ile çağırdık, object ile çağırmadık. min() methodu statictir
