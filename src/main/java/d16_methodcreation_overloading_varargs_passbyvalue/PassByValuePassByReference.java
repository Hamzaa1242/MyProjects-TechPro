...
public class PassByValuePassByReference {
    public static void main(String[] args) {
      /*Pass by Value (Değer ile Geçiş):
        ...
        Java'da genel olarak "pass by reference" kullanılmaz. Bunda degisken ve object'lerin adresleri direkt methoda
        gonderilir.
        ...
        bazi Object'lerin orjinal içeriği degisebilir (Mutable-Değiştirilebilir- Nesneler : ArrayList,
