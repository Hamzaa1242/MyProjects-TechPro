...
public class E03 {
    public static void main(String[] args) {
        ...
        1) finally bloğu genellikle;
         a) Kaynakların serbest bırakılması :  (veritabani baglantisinin kesilmesi, close() methodu ile),
             ...
             yere yer kaplar ve potansiyel performans sorunlarına neden olabilir. Java 7 sonrasi otomatiklesti
             ( try-with-resources ifadesi ile)
    ...
    public static void bring(int[] c, int a, int b){
        ...
        // java da try + bir catch, try + birden fazla catch, try + catch + finally, try + finally kullanılabilir
